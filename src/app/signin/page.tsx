    ...
    <div style={{ backgroundColor: "var(--p-white)", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      <div className="folio-card" style={{ width: "100%", maxWidth: "400px", padding: "40px 32px", animation: "slideUp 0.4s ease-out" }}>
        ...
        <p style={{ fontSize: "14px", color: "var(--t-secondary)", textAlign: "center", marginBottom: "32px" }}>
          {magicLinkSent ? "We sent a magic sign-in link." : "Sign in to pick up where you left off."}
        </p>
        ...
        {!magicLinkSent && (
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              <div style={{ textAlign: "center", color: "var(--t-secondary)", fontSize: "12px", margin: "8px 0" }}>OR</div>

              <button type="button" onClick={handleMagicLink} disabled={isLoading} className="btn-outline" style={{ width: "100%", padding: "12px", borderRadius: "12px", border: "1px solid #E5E7EB", backgroundColor: "white", cursor: isLoading ? "not-allowed" : "pointer" }}>
                 ✨ Send Magic Link 
              </button>
            </form>
        )}
